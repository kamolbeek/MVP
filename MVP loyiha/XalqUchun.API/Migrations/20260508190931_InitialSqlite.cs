        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telegram = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterCategories", x => new { x.MasterId, x.CategoryId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MasterCategories_MasterProfiles_MasterId",
                        column: x => x.MasterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_MasterProfiles_MasterId",
                        column: x => x.MasterId,
                        principalTable: "MasterProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Portfolios_MasterProfiles_MasterId",
                        column: x => x.MasterId,
                        principalTable: "MasterProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_MasterProfiles_MasterId",
                        column: x => x.MasterId,
                        principalTable: "MasterProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-0001-0000-0000-000000000001"), "🔧", "Santexnik", "santexnik" },
                    { new Guid("a1b2c3d4-0002-0000-0000-000000000002"), "⚡", "Elektrik", "elektrik" },
                    { new Guid("a1b2c3d4-0003-0000-0000-000000000003"), "🪚", "Duradgor", "duradgor" },
                    { new Guid("a1b2c3d4-0004-0000-0000-000000000004"), "💻", "Dasturchi", "dasturchi" },
                    { new Guid("a1b2c3d4-0005-0000-0000-000000000005"), "🎥", "Videograf", "videograf" },
                    { new Guid("a1b2c3d4-0006-0000-0000-000000000006"), "🎨", "Dizayner", "dizayner" },
                    { new Guid("a1b2c3d4-0007-0000-0000-000000000007"), "🖌️", "Bo'yoqchi", "boyoqchi" },
                    { new Guid("a1b2c3d4-0008-0000-0000-000000000008"), "🔩", "Payvandchi", "payvandchi" },
                    { new Guid("a1b2c3d4-0009-0000-0000-000000000009"), "🔐", "Chilangar", "chilangar" },
                    { new Guid("a1b2c3d4-0010-0000-0000-000000000010"), "📚", "Repetitor", "repetitor" }
                });
