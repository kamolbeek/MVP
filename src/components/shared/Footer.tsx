      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 pb-10 border-b border-slate-800">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/ustam.uz" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              ...
              <a href="https://t.me/ustam_uz" target="_blank" rel="noopener noreferrer" aria-label="Telegram"
              ...
              <a href="https://youtube.com/@ustam" target="_blank" rel="noopener noreferrer" aria-label="YouTube"
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-xs text-slate-700">
            <Link href="/privacy" className="hover:text-slate-500 transition-colors">Maxfiylik siyosati</Link>
            <span>·</span>
            <Link href="/terms" className="hover:text-slate-500 transition-colors">Foydalanish shartlari</Link>
          </div>
        </div>
      </div>
    </footer>
